...
/**
 * REST controller for managing health data operations (API v1)
 */
@RestController
@RequestMapping("/api/v1/health-data")
@CrossOrigin(origins = {"http://localhost:5173", "http://localhost:5174"}, allowCredentials = "true")
public class HealthDataControllerV1 {

    private static final Logger logger = LoggerFactory.getLogger(HealthDataControllerV1.class);
    ...
    @Autowired
    public HealthDataControllerV1(HealthDataService healthDataService, SamsungHealthService samsungHealthService, UserService userService) {
    ...
    /**
     * GET /api/v1/health-data/user/{userId} : Get all health data for a user
    ...
    /**
     * GET /api/v1/health-data : Get all health data for the current user
     * @return the ResponseEntity with status 200 (OK) and the list of health data in body
     */
    @GetMapping
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/paged : Get all health data for a user with pagination
     * @param userId the ID of the user
    ...
    /**
     * GET /api/v1/health-data/{id} : Get the health data with the specified ID
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/date/{date} : Find health data for a user on a specific date
     * @param userId the ID of the user
     * @param date the date
     * @return the ResponseEntity with status 200 (OK) and the health data in body, or with status 404 (Not Found)
     */
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/date-range : Find health data for a user in a date range
     * @param userId the ID of the user
    ...
    /**
     * GET /api/v1/health-data/date-range : Get health data by date range for the current user
     * @param startDate the start date
     * @param endDate the end date
     * @return the ResponseEntity with status 200 (OK) and the list of health data in body
     */
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/min-steps/{minStepCount} : Find health data for a user with minimum step count
     * @param userId the ID of the user
    ...
    /**
     * POST /api/v1/health-data/user/{userId} : Create or update health data for a user
     * @param userId the ID of the user
    ...
    /**
     * POST /api/v1/health-data/user/{userId}/sync : Sync multiple health data entries for a user
     * @param userId the ID of the user
    ...
    /**
     * DELETE /api/v1/health-data/{id} : Delete the health data with the specified ID
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/count : Count health data entries for a user
     * @param userId the ID of the user
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/average-steps : Get average step count for a user in a date range
     * @param userId the ID of the user
     * @param startDate the start date
     * @param endDate the end date
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/average-heart-rate : Get average heart rate for a user in a date range
     * @param userId the ID of the user
     * @param startDate the start date
     * @param endDate the end date
    ...
    /**
     * GET /api/v1/health-data/user/{userId}/average-sleep : Get average sleep duration for a user in a date range
     * @param userId the ID of the user
     * @param startDate the start date
     * @param endDate the end date
    ...
    /**
     * GET /api/v1/health-data/samsung/auth : Get Samsung Health authorization URL
     * @param userId the ID of the user
    ...
    /**
     * GET /api/v1/health-data/samsung/callback : Handle Samsung Health OAuth callback
    ...
    /**
     * POST /api/v1/health-data/samsung/sync : Manually sync Samsung Health data
     * @param userId the ID of the user
