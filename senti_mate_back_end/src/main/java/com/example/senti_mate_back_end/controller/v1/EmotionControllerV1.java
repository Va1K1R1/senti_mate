...
/**
 * REST controller for managing emotion operations (API v1)
 */
@RestController
...
public class EmotionControllerV1 {
    ...
    @Autowired
    public EmotionControllerV1(EmotionService emotionService, UserService userService) {
    ...
    /**
     * GET /api/v1/emotions/diary/{diaryEntryId} : Get all emotions for a diary entry
    ...
    /**
     * GET /api/v1/emotions/{id} : Get the emotion with the specified ID
    ...
    /**
     * GET /api/v1/emotions/diary/{diaryEntryId}/name/{name} : Find emotions by name for a diary entry
     * @param diaryEntryId the ID of the diary entry
    ...
    /**
     * GET /api/v1/emotions/diary/{diaryEntryId}/intensity/{minIntensity} : Find emotions by minimum intensity for a diary entry
     * @param diaryEntryId the ID of the diary entry
    ...
    /**
     * POST /api/v1/emotions/diary/{diaryEntryId} : Create a new emotion for a diary entry
     * @param diaryEntryId the ID of the diary entry
    ...
    /**
     * POST /api/v1/emotions/diary/{diaryEntryId}/batch : Create multiple emotions for a diary entry
     * @param diaryEntryId the ID of the diary entry
    ...
    /**
     * PUT /api/v1/emotions/{id} : Update an existing emotion
    ...
    /**
     * DELETE /api/v1/emotions/{id} : Delete the emotion with the specified ID
    ...
    /**
     * GET /api/v1/emotions/diary/{diaryEntryId}/count : Count emotions for a diary entry
     * @param diaryEntryId the ID of the diary entry
    ...
    /**
     * GET /api/v1/emotions/user/{userId}/most-common : Get most common emotions for a user
    ...
    /**
     * GET /api/v1/emotions/most-common : Get most common emotions for the current user
     * @param limit the maximum number of results to return
     * @return the ResponseEntity with status 200 (OK) and the map of emotion names to their counts in body
     */
    ...
    /**
     * GET /api/v1/emotions/user/{userId}/average-intensity : Get average intensity by emotion for a user
     * @param userId the ID of the user
    ...
    /**
     * POST /api/v1/emotions/analyze : Analyze text to detect emotions
    ...
    /**
     * GET /api/v1/emotions/stats : Get emotion statistics for a date range for the current user
